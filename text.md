...
# Exam Cheat Sheet (One-Line Answers)

### DTI
- Stands for: Drug-Target Interaction.
- Entities: Drug + Target Protein.
- Goal: Predict interactions between drugs and biological targets.
- AI Methods: Random Forest, SVM, Deep Learning, GNN.
- Data Representation: Molecular fingerprints, SMILES, protein sequences.

### Drug Toxicity
- Goal: Predict harmful effects of drugs.
- Data Representation: Molecular fingerprints, descriptors, molecular graphs.
- AI Methods: Random Forest, Neural Networks.
- Outcome: Toxic vs Non-toxic prediction.

### Drug Repurposing
- Goal: Find new uses for existing drugs.
- AI Methods: Network Analysis, Graph Neural Networks.
- Data Representation: Drug-target-disease networks.
- Outcome: Candidate drugs for new diseases.

### Antimicrobial Resistance (AMR)
- Goal: Predict resistance of microorganisms to antibiotics.
- Data Representation: DNA sequences, genomic data.
- AI Methods: SVM, Deep Learning.
- Outcome: Resistant or Susceptible classification.

### Microbial Diagnosis
- Goal: Identify disease-causing microorganisms.
- Data Representation: Images, DNA sequences.
- AI Methods: CNNs and Deep Learning.
- Outcome: Classification of microbial species.
...
Memorizing these keywords and the five structured answers will likely cover the majority of essay and definition questions mentioned in the exam guidelines.
